...
const Products = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-brand-dark selection:bg-brand-blue selection:text-white">
      ...
      <section className="w-full flex justify-center bg-white px-6 md:px-12 lg:px-40 py-16 lg:py-24 border-t border-[#dce6ee]">
        <div className="w-full max-w-[1440px] flex flex-col items-center gap-12">
          ...
          <div className="w-full max-w-[1144px] flex flex-col gap-8">
            <div className="w-full flex flex-col lg:flex-row gap-8 items-stretch">
              {/* Main Product Card */}
              <div className="w-full lg:w-[606px] flex flex-col bg-white rounded-[28px] border border-[#dce6ee] overflow-hidden group shadow-md relative">
                <div className="w-full h-[500px] lg:h-full relative overflow-hidden bg-[#e8f0f6]">
                  <img src={heroProduct.images[0]} className="w-full h-full object-cover" alt={heroProduct.title} />
            ...
            <div className="w-full grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {gridProducts.map((item, i) => (
                <div key={i} className="flex flex-col bg-white rounded-3xl border-2 border-border-accent group overflow-hidden h-auto relative">
