      ...
      <div className="mt-10 grid md:grid-cols-2 gap-6">
        {blogs.map((b, i) => (
          <div key={i} className="rounded-2xl overflow-hidden border border-border text-left group hover:shadow-lg transition-shadow">
            <img src={b.img} alt={b.title} className="w-full h-52 object-cover group-hover:scale-105 transition-transform" loading="lazy" />
            <div className="p-5">
              ...
              <Button className="mt-4 rounded-full bg-primary text-primary-foreground hover:bg-primary/90">Read More</Button>
            </div>
          </div>
        ))}
      </div>
