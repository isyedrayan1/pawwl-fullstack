...
const features = [
  ...
  { icon: Clock, title: "Flexible Hours", desc: "Available when you need us most" },
  ...
  <section className="py-20 bg-background">
    <div className="container mx-auto px-4 text-center">
      ...
      <div className="mt-12 grid md:grid-cols-5 gap-8 items-center">
        <div className="md:col-span-2 bg-primary rounded-2xl p-10 text-center text-primary-foreground">
          <span className="text-6xl md:text-8xl font-heading font-black leading-none">50K+</span>
          <p className="mt-3 text-sm opacity-80">Pets served & counting</p>
        </div>

        <div className="md:col-span-3 grid grid-cols-2 gap-4">
          {features.map((f) => (
            <div key={f.title} className="bg-muted rounded-2xl p-5 text-left hover:shadow-md transition-shadow">
              <f.icon size={24} className="text-secondary mb-3" />
