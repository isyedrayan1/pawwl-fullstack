...
import { clearSessionCookie, createSession, destroyCurrentSession, requireAuth, setSessionCookie, setAdminSessionCookie, clearAdminSessionCookie, destroyAdminSession, requireAdmin, } from "../middleware/auth.js";
...
router.post("/firebase-login", asyncHandler(async (req, res) => {
    ...
    if (!email)
        throw new HttpError(400, "Email is required from Firebase");
    // Find or create user
